...
%           aim_v;...
%           norm_v]';
T = R_dist'*R_prox;  %transfer function between global to bat frame
...
[mic2bat_2d(:,1),mic2bat_2d(:,2),mic2bat_2d(:,3)] =...
    cart2sph(mic_to_bat_vec_rot(:,1),mic_to_bat_vec_rot(:,2),mic_to_bat_vec_rot(:,3));  %Transform Cartesian coordinates to spherical
...
mic2bat_x(adj_idx,2) = pi-mic2bat_x(adj_idx,2);  % compensate for the elevation 。%？？？？why???
